...
<div class="tabla">
    ...
    <table id = "tabla">
        <thead>
            <tr>
                <th>ID</th><th>Nombres</th><th>Apellidos</th><th>Correo</th><th>Direccion</th><th>Ciudad</th><th>Departamento</th><th>Telefono</th><th>Opciones</th>
            </tr>
            <hr>
        </thead>
        <tbody>
            <?php
                ...
                while ($resultado = $resultados->fetch_row()){
                    echo "<tr><td>$resultado[1]</td><td>$resultado[2]</td><td>$resultado[3]</td><td>$resultado[4]</td><td>$resultado[5]</td><td>$resultado[6]</td><td>$resultado[7]</td><td>$resultado[8]</td><td><a class='edit' href='../php/clientes/update.php?id=$resultado[0]&cc=$resultado[1]&nom=$resultado[2]&ape=$resultado[3]&mail=$resultado[4]&dir=$resultado[5]&ciudad=$resultado[6]&dep=$resultado[7]&tel=$resultado[8]'>Edit</button><a class='delete' href='../php/clientes/delete.php?id=$resultado[0]'>Delete</button></td></tr>";
                }
            ?>
        </tbody>
    </table>
...
<form action="../php/clientes/insert.php" id="form" method="POST">
    ...
    <div class="content"><br>
        ...
        <select type="" id="departamento" name="departamento">
        ...
        <label for="">Telefono: </label><input type="text" id="telefono" name="telefono"><br><br><br><hr> 
    </div>
    <div class="buttons">
