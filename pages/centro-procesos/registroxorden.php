...
<body>
    ...
    <?php
    include("../php/db.php");
    include("procesos/o_procesos.php");
    ?>
    ...
    <div class="container-sm mt-5 p-5 bg-white">
        ...
        <div class="row">
            <main class="p-1">
                <br>
                <hr>
                <div class="table-responsive overflow-x-hidden me-5 ms-1">
                    <table class="table">
                        ...
                        <tbody id="datos">
                            ...
                            if (isset($_COOKIE['value'])) {
                                $m = $_COOKIE['value'];
                                $proceso->procesosByFecha($conn, $m);
                            } else {
                                $td = $proceso->muestraProcesos($conn);
                            }
                            ?>
                        </tbody>
                    </table>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "elimina.php?id=" + recordId;
                    });
                }
            });
        });
