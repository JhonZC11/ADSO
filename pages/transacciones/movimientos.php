...
<body>
    ...
    <div class="proveedores" id="form2">
        <div class="bar" id="">
            <div class="txt-m">Proveedores</div>
            <div class="close"><button id="closeUsuarios" onclick="cierraForm2();">X</button></div>
        </div>
        <table>
            <thead>
                <th>Nit</th>
    ...
    <div id="modalItems" class="lista-items w-25">
        <div class="bar" id="">
            <div class="txt-m">Lista Items</div>
            <div class="close"><button id="closeUsuarios" onclick="cierraForm2();">X</button></div>
        </div>
        <table class="table">
            <thead>
    ...
    <div class="container mt-5">
        <div class="row">
            <main class="p-sm-5 p-md-5">
                <div class="row">
                    <div class="col d-none d-xl-block ">
                        <h1 class="text-center mx-2 my-2 "><strong> Transacciones </strong></h1>
                    </div>    
                    <div class="col-6 d-none d-sm-block">
                        <h2 class="text-center mx-3 my-3 fw-bold">EAC y DB hasta ahora: <?php echo $t; ?></h2>        
                    </div>
                    <div class="col text-center  mx-3 my-3 align-items-center">
                        <button type="button" id="abreModal" class="agregar m-sm-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar</button>
    ...
    <footer>
        <img src="../../img/bg.png" alt="" class="img-fluid d-none d-xxl-block" width="10%">
    </footer>
